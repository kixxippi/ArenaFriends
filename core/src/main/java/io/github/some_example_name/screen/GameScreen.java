...
public class GameScreen extends ScreenAdapter {
    ...
    // extracted game logic controller
    ...
    public void show() {
        ...
        // controller is always available (also in testMode)
        ...
        if (testMode) {
            ...
            // IMPORTANT: no textures in tests
    ...
    public void render(float delta) {
        ...
        // core logic (works in testMode too)
